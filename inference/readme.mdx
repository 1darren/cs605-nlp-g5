...
ZT's results: 
 - DistilGPT2: light-weight baseline for comparison, no extra prompts other than the questions themselves.
   -- filled_answers__unfinetuned_distilgpt2: unfinetuned result, answers are very unspecific.
   -- filled_answers__finetuned_distilgpt2_30: finetuned result with 30 training epochs, great convergence, answers seem pretty rick.
